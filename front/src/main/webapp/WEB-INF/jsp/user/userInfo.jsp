            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" id="form1" action="<%=ctxPath%>/user/update.do">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                   ...
                                   />男</label>
                                    ...
                                    <c:if test="${user.isMale==false}"> checked="checked" </c:if>
                                     />女</label>                                        
                                </div>
                            </div>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-7">
	                                    <div class="col-md-5" style="padding-left:0px;">
	                                        <input type="text" name="smsCode" class="form-control" value="${param.smsCode}" />
	                                    </div>
