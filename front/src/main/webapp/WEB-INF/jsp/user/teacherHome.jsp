            ...
            <div class="col-xs-6">
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body"> 
                        <a style="color: red;" href="<%=ctxPath%>/question/list.do?condition=allUnresolved" target="_blank">查看问题列表 &gt;&gt;</a>
    		...
    		$.post('<%=ctxPath%>/notification.do',{},function(ajaxResult){
    			if(ajaxResult.status=="success"){
    				...
    				for(var i=0;i<notifications.length;i++){
    					...
    					//追加新通知
    					$("#questionDiv").append('<a  class="blink"  id="question'+questionId+'" href="<%=ctxPath%>/question/detail.do?id='+questionId+'" target="_blank" onclick="$(this).remove()">'+content+'</a>');
    				}
    			}
