<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@taglib uri="http://rupeng.com/tag/" prefix="rupeng" %>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <c:if test="${question.isResolved==null || question.isResolved==false}">
                    ...
                    <form action="<%=ctxPath%>/question/answer.do" onsubmit="ajaxSubmitForm(this)" method="post">
                ...
                <div class="panel panel-success">
                    <div class="panel-body">
                        <!-- 答案列表 -->
                       <rupeng:questionAnswers question="${question}" rootAnswers="${questionAnswerList}"/>
