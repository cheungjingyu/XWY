    		...
    		<dl id="menu-picture">
    			...
    			<dd>
    				<ul>
                        ...
                        <li><a _href="<%=ctxPath%>/card/list.do" href="javascript:void(0)">学习卡管理</a></li>
                        <li><a _href="<%=ctxPath%>/cardSubject/order.do" href="javascript:void(0)">学习卡排序</a></li>
    					<li><a _href="<%=ctxPath%>/user/list.do" href="javascript:void(0)">前台用户管理</a></li>
                        <li><a _href="<%=ctxPath%>/classes/list.do" href="javascript:void(0)">班级管理</a></li>
    				</ul>
    			</dd>
    		</dl>
